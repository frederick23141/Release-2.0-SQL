...
Public Class frm_consulta_buzon
            ...
            If val = True Then
                ...
                If resp = 6 Then
                    ...
                    If objOpSimplesLn.ejecutar(sql, "CORSAN") Then
                        ...
                        enviarCorreoMan(consecutivo_mod)
                        consultar()
                    End If
                End If
            Else
    ...
    ''METODO PARA ENVIAR CORREO DE SOLICITUD
    Private Sub enviarCorreoMan(ByVal numero As Double)
        ...
        Dim mail As String = "federico.toro@corsan.com.co"
        Dim asunto As String = "Se ingreso solicitud de mantenimiento por parte de " & cbo_area.Text & ""
        ...
        mailEnvia = "infocorsanmantenimiento@gmail.com"
        mailEnviaPass = "Corsan1234"
        obj_correoLn.EnviarCorreo(mail, cuerpo, asunto, "", mailEnvia, mailEnviaPass, False)
    End Sub

    Private Sub enviarCorreoEstado(ByVal asunto As String, ByVal cuerpo As String, ByVal numero As Double)
        Dim sql_admin As String = "SELECT mail,Mail_login  FROM Jjv_usuarios WHERE usuario = 'ADMIN' "
        Dim dt_admin As DataTable = objOpsimpesLn.listar_datatable(sql_admin, "CORSAN")

        Dim mail As String = "federico.toro@corsan.com.co"

        asunto = "Se ingreso solicitud de mantenimiento por parte de " & cbo_area.Text & ""
        cuerpo = "Número de la solicitud : " & numero & "" & vbCrLf &
                                "Fecha: " & Now
        Dim mailEnvia As String = dt_admin.Rows(0).Item("mail")
        Dim mailEnviaPass As String = dt_admin.Rows(0).Item("Mail_login")
        mailEnvia = "infocorsanmantenimiento@gmail.com"
