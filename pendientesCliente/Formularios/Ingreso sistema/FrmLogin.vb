...
Public Class FrmLogin
    ...
    Private Sub txtContra_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If e.KeyChar = Microsoft.VisualBasic.ChrW(13) Then
            btnIngresar.PerformClick()
        End If
    End Sub
    Private Sub txtUsuario_Enter(ByVal sender As Object, ByVal e As EventArgs)
        Guna2TextBox1.BackColor = Color.FromArgb(251, 173, 33)
    End Sub
    Private Sub txtUsuario_Leave(ByVal sender As Object, ByVal e As EventArgs)
        Guna2TextBox1.BackColor = Color.White
    End Sub
    Private Sub txtContra_Enter(ByVal sender As Object, ByVal e As EventArgs)
        txtContra.BackColor = Color.FromArgb(251, 173, 33)
    End Sub
    Private Sub txtContra_Leave(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Private Sub Guna2TextBox2_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtContra.KeyPress
        If e.KeyChar = Microsoft.VisualBasic.ChrW(13) Then
            btnIngresar.PerformClick()
        End If
    End Sub

    Private Sub Guna2TextBox2_Leave(sender As Object, e As EventArgs) Handles txtContra.Leave
        txtContra.FillColor = Color.White
    End Sub
