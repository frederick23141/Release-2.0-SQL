...
Public Class Frm_consult_ordenes_compra
    ...
    Public Sub Main(ByVal usuario As UsuarioEn, ByVal idven As String)
        Me.usuario = usuario
        If (usuario.permiso.Trim <> "ADMIN" And usuario.permiso.Trim <> "COMPRAS" And usuario.permiso.Trim <> "DIR_LOGISTICA" And usuario.permiso.Trim <> "DIR_PRODUCCION" And usuario.permiso.Trim <> "COOR_PROD" And usuario.permiso.Trim <> "CALIDAD") Then
            ...
            End If
        End If
        If usuario.permiso.Trim <> "ADMIN" And usuario.permiso.Trim <> "COMPRAS" And usuario.permiso.Trim <> "COOR_PROD" And usuario.permiso.Trim <> "DIR_PRODUCCION" And usuario.permiso.Trim <> "CALIDAD" Then
