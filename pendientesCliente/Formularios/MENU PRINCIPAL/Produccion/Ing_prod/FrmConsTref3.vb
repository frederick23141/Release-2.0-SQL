...
Public Class FrmConsTref3
    ...
    Public Sub cargar_consulta()
        ...
        dtg_consulta.Columns("paro12").DefaultCellStyle.Format = "N0"
        dtg_consulta.Columns("paro13").DefaultCellStyle.Format = "N0"
        dtg_consulta.Columns("paro14").DefaultCellStyle.Format = "N0"
        totalGrid()
    ...
    Private Sub cargar_paros()
        ...
        Dim vec() As Object = obj_Ing_prodLn.vec_paros(sql, 14)
        Chart1.Visible = True
        Chart1.Titles.Clear()
        Chart1.Series.Clear()
