...
Class Frm_liquidacion
    ...
    Private Sub cargar_consulta()
        ...
        totalizarCol(3)
        totalizarFilas(0, 3, 1)
        totalizarFilas(3, 11, 1)
        totalizarFilas(0, 12, 2)
        totalizarFilas(0, 7, 3)
        calc_porc(10, 12, 1)
        calc_porc(11, 13, 2)
        ...
        If (usuario.permiso.Trim <> "VENDEDOR") Then
            ...
            dtg_ventas.Rows(11).DefaultCellStyle = objOperacionesForm.formatoNegrita(tamano_letra)
            ...
            dtg_ventas.Rows(12).DefaultCellStyle.ForeColor = Color.Blue
            dtg_rentabilidad.Rows(8).DefaultCellStyle.ForeColor = Color.Blue

            dtg_ventas.Rows(12).DefaultCellStyle.Format = "N2"
            dtg_rentabilidad.Rows(8).DefaultCellStyle.Format = "N2"
