...
Public Class Frm_programacion_turnos
    ...
    Public Sub MAIN(ByVal nomb_modulo As String, ByVal usuario As UsuarioEn)
        ...
        End If
        If centros = "" Then
            centros = "1100,1200,2100,2117,2200,2300,2400,2500,2600,2800,3100,3200,3500,4100,4110,4200,4300,4500,5200,5300,5400,6200,6400"
        End If
        dt = New DataTable
        Dim dr As DataRow
        Dim where_sql As String = ""
        where_sql &= "WHERE centro IN(1100,1200,2100,2117,2200,2300,2400,2500,2600,2800,3100,3200,3500,4100,4110,4200,4300,4500,5200,5300,5400,6200,6400)"
    ...
    Private Sub ingresar_novedad()
        If validar_novedad() Then
            ...
            Dim fecha_fin As String = objOpSimplesLn.cambiarFormatoFecha(cbo_fec_novedad.Value)
